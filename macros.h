...
#define FONT_ROWS 7
#define FONT_COLS 18
#define FONT_CHARACTER_WIDTH  ((float)FONT_WIDTH  / (float)FONT_COLS)
#define FONT_CHARACTER_HEIGHT ((float)FONT_HEIGHT / (float)FONT_ROWS)
#define FONT_SCALE 3

// glyph macros
#define GLYPH_BUFFER_CAPACITY 500000
